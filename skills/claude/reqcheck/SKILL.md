...
4. Run the common bug scenario check below.
5. Give a smallest useful version and a fuller version.
6. List risks and not-doing tradeoffs.
7. Ask at most 3 questions that change the direction.
8. After the user confirms, output a development brief.
...
## Acceptance
How a non-code user can verify this is done.
